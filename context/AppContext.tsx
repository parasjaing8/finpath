  ...
  const addAsset = useCallback(async (a: Asset): Promise<boolean> => {
    ...
    try {
      const sqliteId = await dbCreateAsset({
        ...
        expected_roi: a.expected_roi ?? null,
        ...
        cliff_date: (a.cliff_date as string | null | undefined) ?? null,
        value_currency: (a.value_currency as string | null | undefined) ?? null,
        recurring_amount_currency: (a.recurring_amount_currency as string | null | undefined) ?? null,
