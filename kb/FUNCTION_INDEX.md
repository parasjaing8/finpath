...
| Export | Type | Notes |
|---|---|---|
| `ASSET_CATEGORIES` | const array in `app/(tabs)/assets.tsx` | 12 categories: EQUITY, MUTUAL_FUND, DEBT, FIXED_DEPOSIT, PPF, EPF, GOLD, REAL_ESTATE, CRYPTO, CASH, ESOP_RSU, OTHERS |
...
| `DEFAULT_GROWTH_RATES` | Record in `engine/types.ts:44` | EQUITY/MUTUAL_FUND/ESOP_RSU=12%, DEBT/FIXED_DEPOSIT=7%, PPF=7.1%, EPF=8.15%, GOLD/REAL_ESTATE=8%, CRYPTO=15%, CASH=3.5%, OTHERS=8% |
