...
function computeHealthScore(
  ...
  let label: string;
  let color: string;
  if (capped >= 80) { label = 'On Track'; color = '#1B5E20'; }
  else if (capped >= 60) { label = 'Minor Gap'; color = '#33691E'; }
  else if (capped >= 40) { label = 'Needs Attention'; color = '#F57C00'; }
  else { label = 'Target Gap'; color = '#C62828'; }
...
<div class="row" style="justify-content:space-between;align-items:flex-start">
  ...
  <div style="text-align:center">
    ${gaugeSvg}
    <div style="font-size:9px;color:#888;text-align:center">Projection Score</div>
  </div>
</div>
...
<div class="summary-grid">
  <div class="stat-card">
    <div class="stat-label">Estimated Monthly Investment</div>
...
<h2>Sensitivity Analysis — Illustrative Model Outcomes</h2>
${sensitivityTable}
...
<h2>How Your Projection Score Works</h2>
<p style="font-size:11px;color:#444;margin-bottom:10px">
  A score of <strong style="color:${health.color}">${health.score}/100 (${health.label})</strong> is calculated from four plan components.
  Each measures a different dimension of the mathematical projection.
</p>
...
<p style="font-size:9px;color:#aaa;margin-top:6px">
  Score bands: 80–100 = On Track · 60–79 = Minor Gap · 40–59 = Needs Attention · 0–39 = Target Gap.
...
<div class="footer">
  Generated by FinPath Projection Engine · ${date}<br/>
  This report contains mathematical projections generated from user-provided information and selected assumptions. It is intended for educational and planning purposes only and should not be interpreted as personalized investment advice.<br/>
  FinPath is not a SEBI-registered investment advisor. Consult a licensed SEBI RIA before making investment decisions.
</div>
